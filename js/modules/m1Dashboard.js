...
export class Module1Dashboard {
            ...
            <div class="grid grid-4 kpi-row">
              ...
              <div class="card kpi-card" >
                <div class="kpi-header">
                  ...
                  <span class="badge" style="background: rgba(249, 115, 22, 0.1); color: #f97316; border: 1px solid rgba(249, 115, 22, 0.2);">Live</span>
                </div>
                <div class="kpi-body">
              ...
              <div class="card kpi-card" >
                <div class="kpi-header">
                  ...
                  <span class="badge" style="background: rgba(56, 189, 248, 0.1); color: #38bdf8; border: 1px solid rgba(56, 189, 248, 0.2);">Live</span>
                </div>
                <div class="kpi-body">
              ...
              <div class="card kpi-card" >
                <div class="kpi-header">
                  ...
                  <span class="badge" style="background: rgba(192, 132, 252, 0.1); color: #c084fc; border: 1px solid rgba(192, 132, 252, 0.2);">Live</span>
                </div>
                <div class="kpi-body">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
              <div class="card">
                <div class="card-header">
                  ...
                  <div style="background: var(--bg-surface); border: 1px solid var(--border-subtle); border-radius: var(--radius-md); padding: 16px; margin-bottom: 24px; min-height: 250px;">
  ...
  renderSVGChart(history, metricKey) {
    ...
    if (metricKey === 'food') {
        ...
        color = '#10b981'; // Always green for the score trajectory
      }
    ...
    return `
      <svg width="100%" height="auto" style="overflow: visible;" viewBox="0 0 ${width} ${height}" style="overflow: visible;">
        <defs>
  ...
  attachEventListeners() {
    // 1. Left Sidebar Navigation Buttons (App Shell)
    ...
    // 2. Trajectory Graph Metric Toggle Buttons
    ...
    // 3. Table Quarter/MTD Filter Tabs
